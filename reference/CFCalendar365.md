...
This class represents a CF calendar of 365 days per year, having no leap
days in any year. This calendar is not compatible with the standard
POSIXt calendar.
...
- [`CFCalendar365$new()`](#method-CFCalendar365-new)

- [`CFCalendar365$valid_days()`](#method-CFCalendar365-valid_days)

- [`CFCalendar365$month_days()`](#method-CFCalendar365-month_days)

- [`CFCalendar365$leap_year()`](#method-CFCalendar365-leap_year)

- [`CFCalendar365$doy()`](#method-CFCalendar365-doy)

- [`CFCalendar365$date2offset()`](#method-CFCalendar365-date2offset)

- [`CFCalendar365$offset2date()`](#method-CFCalendar365-offset2date)

- [`CFCalendar365$clone()`](#method-CFCalendar365-clone)
